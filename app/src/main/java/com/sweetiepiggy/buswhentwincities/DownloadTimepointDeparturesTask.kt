...
class DownloadTimepointDeparturesTask(private val mDownloadedListener: DownloadNexTripsTask.OnDownloadedNexTripsListener,
                                      private val mRouteId: String, private val mDirection: NexTrip.Direction,
    ...
    override fun doInBackground(vararg params: Void): Void? {
        ...
        try {
            val reader = MetroTransitDownloader().openJsonReader(MetroTransitDownloader.NexTripOperation.GetTimepointDepartures(mRouteId, mDirection, mTimestopId))
